<script>
    ...
    const menu_del_url = hostUrl + 'sys/menu/del';
    ...
    const role_del_url = hostUrl + 'sys/role/del';
    ...
    const user_del_url = hostUrl + 'sys/user/del';
    const user_delByBatch_url = hostUrl + 'sys/user/delByBatch';
